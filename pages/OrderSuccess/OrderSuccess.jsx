...
const OrderSucess = () => {
    ...
    return (
        <div style={{ background: '#f5f5fa', with: '100%', height: '100vh', marginTop: '79px' }}>
            <Loading isPending={false}>
                <div style={{ height: '100%', width: '1270px', margin: '0 auto' }}>
                    <h3 style={{ fontSize: '20px' }}>Đơn hàng đặt thành công</h3>
                                ...
                                {state.orders?.map((order) => {
                                    return (
                                        <WrapperItemOrder key={order?.name}>
                                            <div style={{ width: '500px', alignItems: 'center', gap: 4, borderRadius: '#ccc' }}>
