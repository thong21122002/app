...
const DetailsOrderPage = () => {
    ...
    return (
        <Loading isPending={isLoading}>
            <div style={{ width: '100%', height: '100vh', background: '#f5f5fa', marginTop: '79px' }}>
                    ...
                    <WrapperHeaderUser>
                        <WrapperInfoUser>
                            ...
                            <WrapperContentInfo>
                                ...
                                <div className='phon-info'><span>Điện thoại: </span> {data?.shippingAddress?.phone}</div>
                            </WrapperContentInfo>
                        </WrapperInfoUser>
                        <WrapperInfoUser>
                        ...
                        <WrapperInfoUser>
                            ...
                            <WrapperContentInfo>
                                ...
                                <div className='status-payment'>{data?.isDelivered ? 'Đã giao hàng' : 'Chưa giao hàng'}</div>
                                ...
                                <WrapperProduct>
                                    <WrapperNameProduct>
                                        ...
                                        <div style={{
                                            ...
                                            marginLeft: '10px',
                                            height: '70px',
                                        }}>{data?.orderItems[index].name}</div>
                                    </WrapperNameProduct>
